...
<html>
  ...
  <body>
    ...
    <script>
      ...
      // once showView is called, have both views hidden to ensure a blank screen
      // then remove hidden attribute to selected view so it's no longer hidden
      ...
      document.getElementById("addIngredient").onclick = () => {
        ...
        if (ingredient && amount) {
          ...
          // alert just for confirmation that data was submitted for now
          alert(
            `Added ${amount} ${
